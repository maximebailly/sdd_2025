...
\begin{frame}
  ...
  \item Poser les bases \blue{mathématiques} et \blue{algorithmiques} de la \red{statistique inférentielle} et de l'\red{apprentissage automatique}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item \blue{Projet numérique} 10 juillet (30\%)
    ...
    \end{itemize}
  \end{itemize}
  \vskip 0pt plus 1filll \scriptsize
